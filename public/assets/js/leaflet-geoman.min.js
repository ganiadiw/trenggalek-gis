(() => {
    var t = {
            ...
            4102: (t, e) => {
                ...
                Object.defineProperty(e, "__esModule", { value: !0 }),
                    ...
                    (e.convertLength = function (t, e, i) {
                        if ((void 0 === e && (e = "kilometers"), void 0 === i && (i = "kilometers"), !(t >= 0)))
                            throw new Error("length must be a positive number");
                        return u(c(t, e), i);
                    }),
                    (e.convertArea = function (t, i, n) {
                        if ((void 0 === i && (i = "meters"), void 0 === n && (n = "kilometers"), !(t >= 0)))
                ...
                (e.coordAll = function (t) {
                    ...
                    (e.findPoint = function (t, e) {
                        ...
                        switch (i.type) {
                            ...
                            case "Polygon":
                                return (
                                    o < 0 && (o = h.length + o), s < 0 && (s = h[o].length + s), n.point(h[o][s], l, e)
                                );
                            case "MultiLineString":
                                return (
                                    a < 0 && (a = h.length + a), s < 0 && (s = h[a].length + s), n.point(h[a][s], l, e)
                                );
                            case "MultiPolygon":
                                return (
                                    a < 0 && (a = h.length + a),
            ...
            5975: (t, e, i) => {
                ...
                const b = {
                    ...
                    _isRelevantForEdit: function (t) {
                        return (
                            ...
                            ((!L.PM.optIn && !t.options.pmIgnore) || (L.PM.optIn && !1 === t.options.pmIgnore)) &&
                            !t._pmTempLayer &&
                    ...
                    removeLayer: function (t) {
                        ...
                        this._isRelevantForRemoval(e) &&
                            ...
                            e instanceof L.LayerGroup
                                ? (this._fireRemoveLayerGroup(e), this._fireRemoveLayerGroup(this.map, e))
                ...
                var E = {
                    ...
                    _fireCenterPlaced: function () {
                        ...
                        this.__fire(
                            this._layer,
                            "pm:centerplaced",
                            { shape: this._shape, workingLayer: i, layer: n, latlng: this._layer.getLatLng() },
                            t,
                            e
                        );
                    },
                    ...
                    _fireMarkerDragStart: function (t) {
                        ...
                        this.__fire(
                            this._layer,
                            "pm:markerdragstart",
                            { layer: this._layer, markerEvent: t, shape: this.getShape(), indexPath: e },
                            i,
                            n
                        );
                    },
                    ...
                    _fireVertexRemoved: function (t, e) {
                        ...
                        this.__fire(
                            this._layer,
                            "pm:vertexremoved",
                            { layer: this._layer, marker: t, indexPath: e, shape: this.getShape() },
                            i,
                            n
                        );
                    },
                    _fireVertexClick: function (t, e) {
                        ...
                        this.__fire(
                            this._layer,
                            "pm:vertexclick",
                            { layer: this._layer, markerEvent: t, indexPath: e, shape: this.getShape() },
                            i,
                            n
                        );
                    },
                    ...
                    _fireRotationEnable: function (t, e) {
                        ...
                        this.__fire(
                            t,
                            "pm:rotateenable",
                            { layer: this._layer, helpLayer: this._rotatePoly, shape: this.getShape() },
                            i,
                            n
                        );
                    },
                ...
                function K(t) {
                    return (
                        t.options.renderer ||
                        (t._map &&
                            (t._map._getPaneRenderer(t.options.pane) || t._map.options.renderer || t._map._renderer)) ||
                        t._renderer
                    );
                }
                const H = L.Class.extend({
                    ...
                    setGlobalOptions: function (t) {
                        ...
                        this.map.pm.Draw.CircleMarker.enabled() &&
                            !!this.map.pm.Draw.CircleMarker.options.editable != !!i.editable &&
                    ...
                    _getContainingLayer: function () {
                        return this.globalOptions.layerGroup && this.globalOptions.layerGroup instanceof L.LayerGroup
                    ...
                    _addTouchEvents: function (t) {
                        0 === this._touchEventCounter &&
                            ...
                            L.DomEvent.on(t, "touchstart touchend touchcancel", this._canvasTouchClick, this)),
                    ...
                    _removeTouchEvents: function (t) {
                        1 === this._touchEventCounter &&
                            ...
                            L.DomEvent.off(t, "touchstart touchend touchcancel", this._canvasTouchClick, this)),
                ...
                const q = L.Control.extend({
                    ...
                    toggle: function (t) {
                        return (
                            (this._button.toggleStatus = "boolean" == typeof t ? t : !this._button.toggleStatus),
                    ...
                    _makeButton: function (t) {
                        ...
                        return (
                            ...
                            t.disabled &&
                                (L.DomUtil.addClass(r, "pm-disabled"), r.setAttribute("aria-disabled", "true")),
                            n
                        );
                    },
                        ...
                        return (
                            this[e] ||
                                (this[e] = L.DomUtil.create(
                                    "div",
                                    "leaflet-pm-toolbar leaflet-pm-".concat(t, " leaflet-bar leaflet-control")
                                )),
                            this[e]
                        );
                    },
                ...
                var et = {
                    _initSnappableMarkers: function () {
                        (this.options.snapDistance = this.options.snapDistance || 30),
                            (this.options.snapSegment =
                                this.options.snapSegment === undefined || this.options.snapSegment),
                    ...
                    _cleanupSnapping: function (t) {
                        ...
                        delete this._snapList,
                            this.throttledList &&
                                (this._map.off("layeradd", this.throttledList, this), (this.throttledList = undefined)),
                    ...
                    _handleSnapping: function (t) {
                        ...
                        if ((this._fireSnapDrag(s.marker, s), this._fireSnapDrag(this._layer, s), n.distance < o)) {
                            ...
                            (l.lat === h.lat && l.lng === h.lng) ||
                                ((e._snapLatLng = r), e._fireSnap(i, s), e._fireSnap(e._layer, s));
                        } else
                            this._snapLatLng &&
                                (this._unsnap(s),
                                (i._snapped = !1),
                            ...
                            n.eachLayer(function (t) {
                                if (
                                    ...
                                    t.pm._hiddenPolyCircle
                                        ...
                                        : t instanceof L.ImageOverlay && (t = L.rectangle(t.getBounds())),
                                        e.push(t);
                                    var n = L.polyline([], { color: "red", pmIgnore: !0 });
                                    (n._pmTempLayer = !0),
                                        i.push(n),
                                        (t instanceof L.Circle || t instanceof L.CircleMarker) && i.push(n);
                                }
                            }),
                    ...
                    _calcClosestLayers: function (t, e) {
                        ...
                        e.forEach(function (e, o) {
                            if (!e._parentCopy || e._parentCopy !== i._layer) {
                                ...
                                1 === n && (a.distance === undefined || s.distance <= a.distance)
                                    ? (s.distance < a.distance && (r = []), ((a = s).layer = e), r.push(a))
                ...
                const nt = L.Class.extend({
                    ...
                    _finishLayer: function (t) {
                        t.pm && (t.pm.setOptions(this.options), (t.pm._shape = this._shape), (t.pm._map = this._map)),
                    ...
                    _setPane: function (t, e) {
                        "layerPane" === e
                            ? (t.options.pane =
                                  (this._map.pm.globalOptions.panes && this._map.pm.globalOptions.panes.layerPane) ||
                                  "overlayPane")
                            : "vertexPane" === e
                            ? (t.options.pane =
                                  (this._map.pm.globalOptions.panes && this._map.pm.globalOptions.panes.vertexPane) ||
                                  "markerPane")
                            : "markerPane" === e &&
                              (t.options.pane =
                                  (this._map.pm.globalOptions.panes && this._map.pm.globalOptions.panes.markerPane) ||
                                  "markerPane");
                    },
                ...
                (nt.Line = nt.extend({
                        ...
                        if (
                            ...
                            if (e.equals(i[0]) || (i.length > 0 && e.equals(n))) this._finishShape();
                                ...
                                (this._layer._latlngInfo = this._layer._latlngInfo || []),
                                    this._layer._latlngInfo.push({ latlng: e, snapInfo: this._hintMarker._snapInfo }),
                    ...
                    setStyle: function () {
                        var t, e;
                        null === (t = this._layer) || void 0 === t || t.setStyle(this.options.templineStyle),
                            null === (e = this._hintline) || void 0 === e || e.setStyle(this.options.hintlineStyle);
                    },
                })),
                            ...
                            for (var a = Pt(t), o = 0; o < a.length - 1; o++) {
                                ...
                                f.features.length > 0 &&
                                    ...
                                    s.properties.dist < n.properties.dist &&
                                        (((n = s).properties.index = o), (n.properties.location = r)),
                                    l.properties.dist < n.properties.dist &&
                                        (((n = l).properties.index = o + 1), (n.properties.location = r + h)),
                ...
                const te = function (t, e, i) {
                    ...
                    for (var n = Ct(t), r = Pt(e), a = 0; a < r.length - 1; a++) {
                        ...
                        if (
                            ...
                            Qt(r[a], r[a + 1], n, o, "undefined" == typeof i.epsilon ? null : i.epsilon))
                        )
                            return !0;
                    }
                    return !1;
                                ...
                                case "LineString":
                                    return (function (t, e) {
                                        for (var i = !1, n = 0, r = e.coordinates; n < r.length; n++) {
                                            var a = r[n];
                                            if (
                                                (te({ type: "Point", coordinates: a }, t, { ignoreEndVertices: !0 }) &&
                                                    (i = !0),
                                                !te({ type: "Point", coordinates: a }, t, { ignoreEndVertices: !1 }))
                                            )
                                                return !1;
                                        }
                                        return i;
                ...
                (nt.Cut = nt.Polygon.extend({
                                ...
                                try {
                                    ...
                                    return i || (e instanceof L.Polyline && !(e instanceof L.Polygon))
                                        ...
                                        : ((n = t.toGeoJSON(15)),
                                          ...
                                          (o = le(r)),
                                          !(
                                              0 === (s = oe().intersection(a.coordinates, o.coordinates)).length ||
                                              !(1 === s.length ? ue(s[0]) : ce(s))
                                          ));
                                } catch (l) {
                                    return (
                    ...
                    _cutLayer: function (t, e) {
                        ...
                        if (e instanceof L.Polygon)
                            (n = e.toGeoJSON(15)),
                                ...
                                (o = le(r)),
                                (i =
                                    0 === (s = oe().difference(a.coordinates, o.coordinates)).length
                                        ? null
                                        : 1 === s.length
                                        ? ue(s[0])
                                        : ce(s));
                    ...
                    (nt.Text = nt.extend({
                        ...
                        _createMarker: function (t) {
                            ...
                            if (
                                ...
                                if (
                                    ...
                                    null !== (e = this.options.textOptions) && void 0 !== e && e.className)
                                ) {
                                    var n,
                                    ...
                                    (o.pm.textArea = this.textArea),
                                        L.setOptions(o.pm, {
                                            removeIfEmpty:
                                                null ===
                                                    (s =
                                                        null === (l = this.options.textOptions) || void 0 === l
                                                            ? void 0
                                                            : l.removeIfEmpty) ||
                                                void 0 === s ||
                                                s,
                        ...
                        _createTextArea: function () {
                            ...
                            return (
                                (t.autofocus = !0), (t.readOnly = !0), t.classList.add("pm-textarea", "pm-disabled"), t
                            );
                        },
                ...
                const ve = {
                    enableLayerDrag: function () {
                        if (this.options.draggable && this._layer._map) {
                            this.disable(),
                                ...
                                (this._layer instanceof L.Marker || this._layer instanceof L.ImageOverlay) &&
                    ...
                    _overwriteEventIfItComesFromMarker: function (t) {
                        t.target.getLatLng &&
                            ...
                            ((t.containerPoint = this._map.mouseEventToContainerPoint(t.originalEvent)),
                ...
                var Me = {
                    _onRotateStart: function (t) {
                        this._preventRenderingMarkers(!0),
                            ...
                            (this._rotationOriginPoint = be(this._map, this._rotationOriginLatLng)),
                    ...
                    _getRotationCenter: function () {
                        var t = L.polygon(this._layer.getLatLngs(), { stroke: !1, fill: !1, pmIgnore: !0 }).addTo(
                                this._layer._map
                            ),
                            e = t.getCenter();
                    ...
                    rotateLayer: function (t) {
                        ...
                        (r = r < 0 ? r + 360 : r),
                            ...
                            this._fireRotation(this._map || this._layer._map, r, i, this._layer),
                            delete this._startAngle,
                ...
                const we = L.Class.extend({
                    ...
                    _vertexValidation: function (t, e) {
                        ...
                        return (
                            ...
                            this.options[r] && "function" == typeof this.options[r] && !this.options[r](n)
                                ? ("move" === t && (i._cancelDragEventChain = i.getLatLng()), !1)
                ...
                (we.LayerGroup = L.Class.extend({
                        ...
                        0 === e.length && (this._layers = this.getLayers()),
                            ...
                            this._layers.forEach(function (i) {
                                i instanceof L.LayerGroup
                                    ? -1 === e.indexOf(i._leaflet_id) && (e.push(i._leaflet_id), i.pm.enable(t, e))
                                    : i.pm.enable(t);
                            });
                    },
                    disable: function () {
                        ...
                        0 === t.length && (this._layers = this.getLayers()),
                            this._layers.forEach(function (e) {
                                e instanceof L.LayerGroup
                                    ? -1 === t.indexOf(e._leaflet_id) && (t.push(e._leaflet_id), e.pm.disable(t))
                                    : e.pm.disable();
                            });
                    },
                    enabled: function () {
                        ...
                        var e = this._layers.find(function (e) {
                            return e instanceof L.LayerGroup
                                ? -1 === t.indexOf(e._leaflet_id) && (t.push(e._leaflet_id), e.pm.enabled(t))
                                : e.pm.enabled();
                        });
                        return !!e;
                    },
                    toggleEdit: function (t) {
                        ...
                        0 === e.length && (this._layers = this.getLayers()),
                            ...
                            this._layers.forEach(function (i) {
                                i instanceof L.LayerGroup
                                    ? -1 === e.indexOf(i._leaflet_id) && (e.push(i._leaflet_id), i.pm.toggleEdit(t, e))
                                    : i.pm.toggleEdit(t);
                            });
                    },
                                ...
                                ? this._layerGroup.getLayers().forEach(function (t) {
                                      r.push(t),
                                          t instanceof L.LayerGroup &&
                                              ...
                                              (n.push(t._leaflet_id), (r = r.concat(t.pm.getLayers(!0, !0, !0, n))));
                                  })
                    ...
                    (we.Marker = we.extend({
                        ...
                        enable: function () {
                            var t =
                                arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : { draggable: !0 };
                            L.Util.setOptions(this, t),
                    ...
                    filterMarkerGroup: function () {
                        (this.markerCache = []),
                            ...
                            this.throttledApplyLimitFilters ||
                                (this.throttledApplyLimitFilters = L.Util.throttle(this.applyLimitFilters, 100, this)),
                ...
                (we.Line = we.extend({
                                    ...
                                    ? (this.enabled() && this.disable(),
                                      ...
                                      this.options.allowSelfIntersection
                                          ...
                                          : ("#f00000ff" !== this._layer.options.color
                                                ? ((this.cachedColor = this._layer.options.color), (this.isRed = !1))
                                                : (this.isRed = !0),
                    ...
                    disable: function () {
                        if (this.enabled() && !this._dragging) {
                            ...
                            L.DomUtil.removeClass(t, "leaflet-pm-draggable"),
                                (this._map.hasLayer(this._layer) && !this.hasSelfIntersection()) ||
                    ...
                    _handleLayerStyle: function (t) {
                        ...
                        if (this.hasSelfIntersection()) {
                            if (
                                ...
                                return;
                            t ? this._flashLayer() : (e.setStyle({ color: "#f00000ff" }), (this.isRed = !0)),
                    ...
                    _removeMarker: function (t) {
                        ...
                        if (this._vertexValidation("remove", t)) {
                            this.options.allowSelfIntersection ||
                                (this._coordsBeforeEdit = U(this._layer, this._layer.getLatLngs()));
                            ...
                            if (r) {
                                ...
                                if (
                                    ...
                                    if (
                                        ...
                                        if (
                                            (this.isPolygon()
                                                ? ((u = (a + 1) % l.length), (c = (a + (l.length - 1)) % l.length))
                    ...
                    _checkMarkerAllowedToDrag: function (t) {
                        ...
                        return (
                            t.getLatLng() === this._markers[0][0].getLatLng()
                                ? (s += 1)
                                : t.getLatLng() === this._markers[0][this._markers[0].length - 1].getLatLng() &&
                                  (o += 1),
                            !(o <= 2 && s <= 2)
                        );
                    },
                        ...
                        _addMarkerEvents: function () {
                            ...
                            this._markers[0].forEach(function (e) {
                                e.on("dragstart", t._onMarkerDragStart, t),
                                    ...
                                    t.options.preventMarkerRemoval || e.on("contextmenu", t._removeMarker, t);
                            });
                        },
                    ...
                    (we.Circle = we.extend({
                        ...
                        _onMarkerDragEnd: function (t) {
                            var e = t.target;
                            this._vertexValidationDragEnd(e) &&
                                (this._fireEdit(), (this._layerEdited = !0), this._fireMarkerDragEnd(t));
                        },
                        ...
                        _updateHiddenPolyCircle: function () {
                            ...
                            this._hiddenPolyCircle
                                ...
                                : (this._hiddenPolyCircle = L.PM.Utils.circleToPolygon(this._layer, 200, !t)),
                    ...
                    (we.CircleMarker = we.extend({
                        ...
                        applyOptions: function () {
                            !this.options.editable && this.options.draggable
                                ...
                                : this.disableLayerDrag(),
                                this.options.editable
                                    ? (this._initMarkers(), this._map.on("move", this._syncMarkers, this))
                        ...
                        _onMarkerDragEnd: function (t) {
                            ...
                            var e = t.target;
                            this._vertexValidationDragEnd(e) &&
                                (this.options.editable && (this._fireEdit(), (this._layerEdited = !0)),
                                this._fireMarkerDragEnd(t));
                        },
                        ...
                        _updateHiddenPolyCircle: function () {
                            ...
                            if (t) {
                                ...
                                this._hiddenPolyCircle
                                    ...
                                    : (this._hiddenPolyCircle = L.PM.Utils.circleToPolygon(i, 200, !n)),
                                    this._hiddenPolyCircle._parentCopy ||
                                        (this._hiddenPolyCircle._parentCopy = this._layer);
                            }
                        },
                    ...
                    (we.Text = we.extend({
                        ...
                        _documentClick: function (t) {
                            t.target !== this.textArea &&
                                (this.disable(), !this.getText() && this.options.removeIfEmpty && this.remove());
                        },
                        ...
                        _createTextMarker: function () {
                            ...
                            this._layer.off("add", this._createTextMarker, this),
                                ...
                                this._autoResize(),
                                !0 === t && (this.enable(), this.focus(), this._disableOnBlur());
                        },
                    ...
                    (Re.prototype = {
                        ...
                        translate: function (t) {
                            return t === undefined
                                ...
                                : ("number" == typeof t ? ((e = t), (i = t)) : ((e = t.x), (i = t.y)),
                        ...
                        scale: function (t, e) {
                            return t === undefined
                                ...
                                : ((e = e || L.point(0, 0)),
                                  "number" == typeof t ? ((i = t), (n = t)) : ((i = t.x), (n = t.y)),
                ...
                var Ie = {
                    ...
                    findDeepCoordIndex: function (t, e) {
                        ...
                        var a = {};
                        return (
                            i && (a = { indexPath: i, index: i[i.length - 1], parentPath: i.slice(0, i.length - 1) }), a
                        );
                    },
                    findDeepMarkerIndex: function (t, e) {
                        ...
                        var n = {};
                        return (
                            i && (n = { indexPath: i, index: i[i.length - 1], parentPath: i.slice(0, i.length - 1) }), n
                        );
                    },
                    _getIndexFromSegment: function (t, e) {
                        if (e && 2 === e.length) {
                            ...
                            return (
                                ...
                                { indexA: i, indexB: n, newIndex: r, indexPath: i.indexPath, parentPath: i.parentPath }
                            );
                        }
                        return null;
                    },
                ...
                (L.PM = L.PM || {
                    ...
                    addInitHooks: function () {
                        L.Map.addInitHook(function () {
                            ...
                            L.LayerGroup.addInitHook(function () {
                                (this.pm = undefined),
                                    L.PM.optIn
                                        ? !1 === this.options.pmIgnore && (this.pm = new L.PM.Edit.LayerGroup(this))
                                        : this.options.pmIgnore || (this.pm = new L.PM.Edit.LayerGroup(this));
                            }),
                            ...
                            L.CircleMarker.addInitHook(function () {
                                (this.pm = undefined),
                                    L.PM.optIn
                                        ? !1 === this.options.pmIgnore && (this.pm = new L.PM.Edit.CircleMarker(this))
                                        : this.options.pmIgnore || (this.pm = new L.PM.Edit.CircleMarker(this));
                            }),
                            L.Polyline.addInitHook(function () {
                                (this.pm = undefined),
                                    L.PM.optIn
                                        ? !1 === this.options.pmIgnore && (this.pm = new L.PM.Edit.Line(this))
                                        : this.options.pmIgnore || (this.pm = new L.PM.Edit.Line(this));
                            }),
                            L.Polygon.addInitHook(function () {
                                (this.pm = undefined),
                                    L.PM.optIn
                                        ? !1 === this.options.pmIgnore && (this.pm = new L.PM.Edit.Polygon(this))
                                        : this.options.pmIgnore || (this.pm = new L.PM.Edit.Polygon(this));
                            }),
                            L.Rectangle.addInitHook(function () {
                                (this.pm = undefined),
                                    L.PM.optIn
                                        ? !1 === this.options.pmIgnore && (this.pm = new L.PM.Edit.Rectangle(this))
                                        : this.options.pmIgnore || (this.pm = new L.PM.Edit.Rectangle(this));
                            }),
                            L.Circle.addInitHook(function () {
                                (this.pm = undefined),
                                    L.PM.optIn
                                        ? !1 === this.options.pmIgnore && (this.pm = new L.PM.Edit.Circle(this))
                                        : this.options.pmIgnore || (this.pm = new L.PM.Edit.Circle(this));
                            }),
                            L.ImageOverlay.addInitHook(function () {
                                (this.pm = undefined),
                                    L.PM.optIn
                                        ? !1 === this.options.pmIgnore && (this.pm = new L.PM.Edit.ImageOverlay(this))
                                        : this.options.pmIgnore || (this.pm = new L.PM.Edit.ImageOverlay(this));
                            });
                    },
                    ...
                    "1.7.1" === L.version &&
                        L.Canvas.include({
                            _onClick: function (t) {
                                for (
                                    var e, i, n = this._map.mouseEventToLayerPoint(t), r = this._drawFirst;
                                    r;
                                    r = r.next
                                )
                        ...
                        Object.defineProperty(Array.prototype, "includes", {
                            value: function (t, e) {
                                ...
                                for (; s < n; ) {
                                    if (
                                        (r = i[s]) === (a = t) ||
                                        ("number" == typeof r && "number" == typeof a && isNaN(r) && isNaN(a))
                                    )
                                        return !0;
                                    s++;
                                }
            ...
            9465: (t, e, i) => {
                ...
                t.exports = function (t, e, i) {
                    "__proto__" == e && n
                        ? n(t, e, { configurable: !0, enumerable: !0, value: i, writable: !0 })
                        : (t[e] = i);
                };
            },
            3118: (t, e, i) => {
            ...
            5357: (t, e, i) => {
                ...
                t.exports = function (t, e, i) {
                    return (
                        ...
                        function () {
                            for (var a = arguments, o = -1, s = r(a.length - e, 0), l = Array(s); ++o < s; )
                                l[o] = a[e + o];
                            o = -1;
            ...
            2676: function (t) {
                t.exports = (function () {
                    ...
                    function a(t, e, i) {
                        for (var r = new n(null, null), a = r, o = r; ; ) {
                            ...
                            if (s < 0) {
                                ...
                                if (
                                    i(t, e.right.key) > 0 &&
                                    ((l = e.right), (e.right = l.left), (l.left = e), null === (e = l).right)
                                )
                                    break;
                        ...
                        return (
                            ...
                            (t.prototype._remove = function (t, e, i) {
                                ...
                                return null === e
                                    ? null
                                    : 0 === i(t, (e = a(t, e, i)).key)
                                    ? (null === e.left ? (n = e.right) : ((n = a(t, e.left, i)).right = e.right),
                                      this._size--,
                                      n)
                                    : e;
                            }),
                    ...
                    function g(t, e, i) {
                        for (var r = new n(null, null), a = r, o = t, s = e; null !== o && null !== s; )
                            i(o.key, s.key) < 0 ? ((a.next = o), (o = o.next)) : ((a.next = s), (s = s.next)),
                                (a = a.next);
                    ...
                    var L = v * v,
                        ...
                        T = (function () {
                            function e(i, n) {
                                t(this, e),
                                    i.events === undefined ? (i.events = [this]) : i.events.push(this),
                                    (this.point = i),
                                    (this.isLeft = n);
                            }
                            return (
                                    ...
                                    [
                                        ...
                                        },
                                        {
                                            ...
                                            value: function (t) {
                                                ...
                                                return (
                                                    T.comparePoints(s.leftSE.point, s.rightSE.point) > 0 &&
                                                        s.swapEvents(),
                                                    T.comparePoints(this.leftSE.point, this.rightSE.point) > 0 &&
                                                        this.swapEvents(),
                                                ...
                                                switch (q.type) {
                                                    ...
                                                    case "intersection":
                                                        ...
                                                        t.length < e.length
                                                            ...
                                                            (this._isInResult = a === q.numMultiPolys && r < a);
                                                        break;
                                                    case "xor":
                                                    ...
                                                    default:
                                                        throw new Error(
                                                            "Unrecognized operation type found ".concat(q.type)
                                                        );
                                                }
                                ...
                                i(e, [
                                    {
                                        ...
                                        value: function () {
                                            for (
                                                ...
                                                for (
                                                    var n = this.interiorRings[e].getSweepEvents(), r = 0, a = n.length;
                                                    r < a;
                                                    r++
                                                )
                                                    t.push(n[r]);
                                ...
                                i(e, [
                                    {
                                        ...
                                        value: function () {
                                            for (var t = [], e = 0, i = this.polys.length; e < i; e++)
                                                for (
                                                    var n = this.polys[e].getSweepEvents(), r = 0, a = n.length;
                                                    r < a;
                                                    r++
                                                )
                                                    t.push(n[r]);
                                ...
                                i(e, [
                                    ...
                                    },
                                    {
                                        ...
                                        value: function () {
                                            ...
                                            for (
                                                var r = t.segment.prevInResult(), a = r ? r.prevInResult() : null;
                                                ;
                                ...
                                i(e, [
                                    {
                                        ...
                                        value: function (t) {
                                            ...
                                            for (var r = n, a = n, o = undefined, s = undefined; o === undefined; )
                                            ...
                                            if (t.isLeft) {
                                                ...
                                                if (o) {
                                                    ...
                                                    if (
                                                        ...
                                                        for (
                                                            var u = this._splitSafely(o, h), c = 0, p = u.length;
                                                            c < p;
                                                            c++
                                                        )
                                                            i.push(u[c]);
                                                ...
                                                if (s) {
                                                    ...
                                                    if (
                                                        ...
                                                        for (
                                                            var g = this._splitSafely(s, f), _ = 0, m = g.length;
                                                            _ < m;
                                                            _++
                                                        )
                                                            i.push(g[_]);
                                                ...
                                                if (null !== l || null !== d) {
                                                    ...
                                                    (y =
                                                        ...
                                                        i.push(e.rightSE);
                                                    for (var v = e.split(y), L = 0, b = v.length; L < b; L++)
                                                        i.push(v[L]);
                                                }
                                                i.length > 0
                                                ...
                                                if (o && s) {
                                                    ...
                                                    if (null !== k) {
                                                        if (!o.isAnEndpoint(k))
                                                            for (
                                                                var M = this._splitSafely(o, k), x = 0, w = M.length;
                                                                x < w;
                                                                x++
                                                            )
                                                                i.push(M[x]);
                                                        if (!s.isAnEndpoint(k))
                                                            for (
                                                                var C = this._splitSafely(s, k), P = 0, E = C.length;
                                                                P < E;
                                                                P++
                                                            )
                                                                i.push(C[P]);
                        ...
                        H =
                            ("undefined" != typeof process && process.env.POLYGON_CLIPPING_MAX_SWEEPLINE_SEGMENTS) ||
                            1e6,
                        q = new ((function () {
                            function e() {
                                t(this, e);
                                ...
                                i(e, [
                                    {
                                        ...
                                        value: function (t, e, i) {
                                            (q.type = t), x.reset();
                                            for (var n = [new N(e, !0)], r = 0, a = i.length; r < a; r++)
                                                n.push(new N(i[r], !1));
                ...
                t.exports = (function () {
                    ...
                    return (
                            ...
                            for (var i, n, a, o = this.data, s = this.toBBox(t), l = [], h = []; o || l.length; ) {
                                ...
                                a || o.leaf || !p(o, s)
                                    ? n
                                        ...
                                        : (o = null)
                                    : (l.push(o), h.push(i), (i = 0), (n = o), (o = o.children[0]));
                            }
                            return this;
                        }),
                        ...
                        (n.prototype._build = function (t, e, i, n) {
                            ...
                            n || ((n = Math.ceil(Math.log(o) / Math.log(s))), (s = Math.ceil(o / Math.pow(s, n - 1)))),
                                ((r = f([])).leaf = !1),
                                (r.height = n);
                            var l = Math.ceil(o / s),
                        ...
                        (n.prototype._insert = function (t, e, i) {
                            ...
                            for (a.children.push(t), s(a, n); e >= 0 && r[e].children.length > this._maxEntries; )
                                this._split(r, e), e--;
                        ...
                        (n.prototype._allDistMargin = function (t, e, i, n) {
                            t.children.sort(n);
                            for (
                                var r = this.toBBox, a = o(t, 0, e, r), l = o(t, i - e, i, r), h = c(a) + c(l), u = e;
                                u < i - e;
                                u++
                            ) {
                                var p = t.children[u];
