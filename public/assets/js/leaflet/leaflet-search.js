    ...
    L.Control.Search = L.Control.extend({
        ...
        _recordsFromJsonp: function (text, callAfter) {
            ...
            const url = L.Util.template(
                this._getUrl(text) + "&" + this.options.jsonpParam + "=L.Control.Search.callJsonp",
                { s: text }
            ); // parsing url
      ...
      */
        ...
        _handleAutoresize: function () {
            ...
            if (this.options.autoResize && this._container.offsetWidth + 20 < this._map._container.offsetWidth) {
                this._input.size =
                    this._input.value.length < this._inputMinSize ? this._inputMinSize : this._input.value.length;
            }
        },
