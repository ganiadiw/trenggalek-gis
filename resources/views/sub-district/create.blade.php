                ...
                <div>
                    ...
                    <div x-data="{ current: $persist(1) }" class="p-3 mb-3 bg-white border-2 rounded-md shadow-lg border-slate-300">
                        ...
                        <div class="mt-3 text-black">
                            <div x-cloak x-show="current == 1" class="static block xl:flex">
                            ...
                            <div x-show="current == 2" class="block xl:flex">
                                <div class="w-full mb-4 bg-gray-100 border border-gray-200 rounded-lg">
                                    <div class="px-4 py-2 bg-white rounded-t-lg">
                                        <textarea id="geoJSONTextArea" rows="15" class="w-full px-0 text-sm text-gray-900 bg-white border-0" placeholder="Masukkan text geojson...."></textarea>
                                    </div>
                                    <div class="flex items-center justify-between px-3 py-2 border-t">
                                        <button type="button" id="buttonGeoJSONText" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center">Simpan</button>
                                    </div>
                                </div>
                            </div>
                        </div>
