...
<div x-data="{ initial: true, deleting: false }" class="flex items-center text-sm">
    ...
    <div
        ...
        class="absolute flex space-x-3 scale-100 bg-white right-6"
    >
        <span class="px-5 py-1 text-sm text-gray-200 bg-gray-600 rounded-md">@lang('Hapus ') <span class="font-semibold underline">{{ $user }}</span> @lang('?')</span>
