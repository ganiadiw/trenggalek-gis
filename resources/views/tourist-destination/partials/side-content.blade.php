        ...
        <ul class="space-y-5">
            <li>
                <label class="font-semibold text-gray-900">Alamat Destinasi
                    Wisata</label>
                <div id="address" class="flex mt-2 text-sm">
                    <div>
            ...
            <li>
                <label class="font-semibold text-gray-900">Kategori Destinasi
                    Wisata</label>
                <div id="category" class="flex mt-2 text-sm">
                    <div>
            ...
            <li>
                ...
                <div id="distance" class="flex mt-2 text-sm">
                    <div>
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" class="w-5 mt-[2px] text-green-700"
            ...
            <li>
                ...
                <div id="manager" class="flex mt-2 text-sm">
                    <div>
