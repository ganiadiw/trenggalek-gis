        ...
        <div class="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
            <form class="px-8 py-6 mt-5 bg-white border-2 rounded-md shadow-lg" method="POST"
                ...
                <div class="grid gap-x-5 md:grid-cols-2">
                    ...
                    <x-input-default-form type="text" name="phone_number" :value="old('phone_number')" id="phone_number"
                        labelTitle="Nomor Handphone*" error='phone_number' placeholder="081234567889">
                    </x-input-default-form>
                    <x-input-default-form type="password" name="password" id="password" labelTitle="Password*"
                        error='password' placeholder="*********"></x-input-default-form>
                </div>
