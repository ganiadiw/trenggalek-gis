<x-app-layout>
    <div x-data="{ openModalInstruction: false,  svgName: '{{ old('svg_name', $category->svg_name) }}' }">
                                ...
                                <div
                                    ...
                                    <div>
                                        ...
                                        <div class="p-5 mt-1 border-2 border-gray-200 rounded-md shadow-md">
                                            ...
                                            <x-input-select-option class="mt-3" labelTitle="Pilih Warna Marker" id="color"
                                                name="color" error="color">
                                                <x-slot name="options">
                                                    <option disabled selected>Pilih Warna</option>
                                                    @foreach (\App\Models\Category::COLORS as $key => $color)
                                                        <option value="{{ $color['name'] }}"
                                                            @selected(old('color', $category->color) == $color['name'])
